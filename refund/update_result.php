<?php
  ...
  $sql = "UPDATE refundTBL_1 SET grade='".$grade."', class='".$class."', number='".$number."', name='".$name."', program='".$program."', fee1='".$fee1."', fee2='".$fee2."', classTime='".$classTime."', mcost='".$mcost."', total='".$total."', startDate='".$startDate."', memo='".$memo."'";
