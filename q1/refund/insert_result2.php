<?php
  ...
  $sql = "SELECT studentNo FROM refundTBL2_1 ORDER BY studentNo DESC LIMIT 1"; //마지막 studentNo 불러오기
  ...
  $sql = "INSERT INTO refundTBL2_1 VALUES('".$studentNo."', '".$grade."', '".$class."', '".$number."', '".$name."', '".$program."', '".$fee1."', '".$fee2."', '".$classTime."', '".$mcost."', '".$total."', '".$startDate."', '".$memo."')";
